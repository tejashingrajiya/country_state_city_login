...
$id = isset($_GET['id']) ? $_GET['id'] : '';
  $var="SELECT * FROM tbl2 WHERE id='$id'";
...
<div class="regform">
 <h1>Registration_Form</h1>
  ...
  <form action="" id="Registration_Form" name="myForm" method="POST" enctype="multipart/form-data" class="countryform">
     ...
     <br><span style="color:red;"><?php echo $errr; ?></span><br>
...
?>
            ...
            <?php 
              ...
              {?>
                <option value=' <?php echo $value["id"]; ?>' <?php if($value["id"] == $row['country']){echo "selected";} ?>><?php echo $value["country"]; ?></option>;
                <?php
              }
              ?>
        ...
        <div class="name">
            ...
            <select name="state" id="state">
              ...
              {
                ?>
                <option value=' <?php echo $value2["sid"]; ?>' <?php if($value2["sid"] == $row['state']){echo "selected";} ?>><?php echo $value2["state"]; ?></option>;
                <?php
              }
              ?>
          ...
          <br>
            ...
            <option value=''>select city</option>
              ...
              {
                ?>
                <option value='<?php echo $value2["cid"]; ?>' <?php if($value2["cid"] == $row['city']){echo "selected";} ?>><?php echo $value2["city"]; ?></option>;
                <?php
              }
              ?>                            
    ...
    <input type="button" name="table"  value="back to table" onclick='window.location.href="view.php"'/>
